...
//             const value = getNestedValue(tableDatum, column.key); // ✅ Now it works
//             return value != null && value.toString().toLowerCase().includes(query);
//         });

//         const tableDate = getNestedValue(tableDatum, 'date') ? new Date(getNestedValue(tableDatum, 'date')) : null;
//         const formattedTableDate = isValid(tableDate) ? format(tableDate, "yyyy-MM-dd") : null;
...
//                             <tbody>
//                                 {currentItems.map((datum, rowIndex) => (
//                                     <tr key={rowIndex} onClick={() => onRowClick && onRowClick(datum)}>
//                                         {columns.map((column, colIndex) => (
//                                             <td key={colIndex} style={{ textAlign: "center", fontSize: "13px", fontWeight: "500" }}>
//                                                 {column.format ? column.format(getNestedValue(datum, column.key)) : getNestedValue(datum, column.key)}
//                                             </td>
//                                         ))}
//                                         {showActions && (
